# step for git before PR (pull request)

0. come to main branch
- git checkout main
1. update the local main branch to the remote latest code: 
- git pull
2. create new branch for the new feature / work
